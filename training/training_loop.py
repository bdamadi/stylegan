...
def training_loop(
    ...
    resume_run_id           = '/content/drive/MyDrive/GANs/00007-sgan-kitchen256-1gpu/network-snapshot-026600.pkl',     # Run ID or network pkl to resume training from, None = start from scratch.
    resume_snapshot         = None,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 26600.0,  # Assumed training progress at the beginning. Affects reporting and training schedule.
