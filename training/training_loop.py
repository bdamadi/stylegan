...
def training_loop(
    ...
    resume_run_id           = '/content/drive/MyDrive/GANs/00006-sgan-kitchen256-1gpu/network-snapshot-025800.pkl',     # Run ID or network pkl to resume training from, None = start from scratch.
    resume_snapshot         = None,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 25800.0,  # Assumed training progress at the beginning. Affects reporting and training schedule.
