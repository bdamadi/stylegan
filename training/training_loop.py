...
def training_loop(
    ...
    resume_run_id           = '/content/drive/MyDrive/LSUN/karras2019stylegan-bedrooms-256x256.pkl',     # Run ID or network pkl to resume training from, None = start from scratch.
